...
public class TapAction {
    ...
    public void tapTest() throws MalformedURLException {
        ...
        touchAction.tap(TapOptions.tapOptions()
                .withElement(ElementOption.element(expandableLists))).perform();

        WebElement elementByAccessibilityId =
                driver.findElementByAccessibilityId("1. Custom Adapter");
        touchAction.tap(TapOptions.tapOptions()
                .withElement(ElementOption.element(elementByAccessibilityId))).perform();
...
//        WebElement tabsButton = driver.findElementByAccessibilityId("Tabs");
     ...
     WebElement tabsButton = driver.findElementByAndroidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView(text(\"Tabs\"))");
